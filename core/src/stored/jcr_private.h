...
struct JobControlRecordPrivate {
  ...
  alist<storagedaemon::StorageResource>* write_store{};           /**< List of write storage devices sent by DIR */
  alist<storagedaemon::StorageResource>* read_store{};            /**< List of read devices sent by DIR */
